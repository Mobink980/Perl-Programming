...
#in this class we use simple hash in the constructor
# as we don't want to assign any value to class variables
package Person1; #class definition
sub new {
   my $class = shift;
   my $self = {};
   bless $self, $class;
...
$object1 = new Person1(); #object creation
